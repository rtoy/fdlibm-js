describe(
    "Test special cases",
    function () {
        it("Math.log2(x) = NaN for x < 0",
           function () {
               var y = Math.log2(-1);
               expect(y).toBeNaN();
           });
        it("Math.log2(-0) = -Infinity",
           function () {
               var x = 1 / -Infinity;
               var y = Math.log2(x);
        ...
        it("Math.log2(NaN) = NaN",
           function () {
               var y = Math.log2(NaN);
               expect(y).toBeNaN();
           });
        it("Math.log2(Infinity) = Infinity",
           function () {
               var y = Math.log2(Infinity);
               expect(y).toBe(Infinity);
           });
        it("Math.log2(-Infinity) = NaN",
           function () {
               var y = Math.log2(-Infinity);
               expect(y).toBeNaN();
           });
...
describe(
    ...
    function () {
        it("Math.log2(2^n) = n for n -1074 <= n <= 1023",
           function () {
...
describe(
    ...
    function () {
        ...
        it("Math.log2(sqrt(2)) = 0.5000000000000001",
           function () {
               var x = Math.SQRT2;
               var y = Math.log2(x);
        ...
        it("Math.log2(1/sqrt(2)) = -0.4999999999999999",
           function () {
               var x = Math.SQRT1_2;
               var y = Math.log2(x);
        ...
        it("Math.log2(10) = 3.321928094887362",
           function () {
               var y = Math.log2(10);
               expect(y).toBe(3.321928094887362);
           });
        it("Math.log2(100) = 6.643856189774724",
           function () {
               var y = Math.log2(100);
...
describe(
    "Test relationships",
    function () {
        it("|Math.log2(1/x) + Math.log2(x)| <= 1.5e-14, x = 1.1^k, 0 <= k < 1000",
           function () {
               var x = 1;
        ...
        it("|Math.log2(x) - log(x)/log(2)| < 1e-15, x = 1.1^k, 0 <= k < 1000 ",
           function () {
